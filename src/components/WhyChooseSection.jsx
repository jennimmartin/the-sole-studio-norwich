          ...
          <div className="space-y-4 text-base md:text-lg">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span>Specialist foot care without a clinical setting</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-xl">✓</span>
                <span>A private, appointment-only environment</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-xl">✓</span>
                <span>Honest, judgement-free treatment</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-xl">✓</span>
                <span>Support for active lifestyles and demanding jobs</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-xl">✓</span>
