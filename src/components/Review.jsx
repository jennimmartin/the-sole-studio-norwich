    ...
    <Section width="wide">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="border border-neutral-200 p-8 flex flex-col">
          ...
          <p className="text-sm md:text-base italic mb-6 flex-grow">
            "Professional, calming, and incredibly thorough — my feet have never
            felt better."
          </p>
          <div className="mt-auto">
            <ViewTreatmentsButton variant="primary" size="large" />
        ...
        <div className="border border-neutral-200 p-8 flex flex-col">
          ...
          <p className="text-sm md:text-base italic mb-6 flex-grow">
            "I was self-conscious about my toenails for years. The results were
            amazing and so natural."
          </p>
          <div className="mt-auto">
            <ViewTreatmentsButton variant="primary" size="large" />
          </div>
