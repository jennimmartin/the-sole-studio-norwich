...
// Customer Policies Data
const customerPolicies = [
  {
    title: "Booking & Appointments",
    content: `• All appointments must be made in advance either online or by phone
• A valid name, contact number, and email address must be provided at the time of booking
• Appointments are not confirmed until the customer receives a confirmation email or message`,
  },
  {
    title: "Customer Arrival & Check-In",
    content: `• Please arrive 10–15 minutes early to allow time for check-in and preparation
• Late arrivals may result in the appointment being shortened or rescheduled
• The studio reserves the right to refuse entry if a client is excessively late`,
  },
  {
    title: "Cancellation & Rescheduling",
    content: `• Cancellations or reschedules must be made at least 24 hours before the scheduled appointment
• Late cancellations (less than 24 hours' notice) may incur a cancellation fee or lose the appointment charge
• No-shows (missed appointments without notice) may be charged in full
• Refunds or reschedules for missed appointments are at management discretion`,
  },
  {
    title: "Payments & Fees",
    content: `• Full payment is required at the time of booking or before the service begins
• Accepted payment methods include major credit/debit cards and online payments
• Any outstanding balances must be settled before service delivery`,
  },
  {
    title: "Refund Policy",
    content: `• Refunds are not provided for completed services
• If a prepaid session or package hasn't been used, refunds may be considered up to a certain date before service begins
• Refunds for product purchases follow statutory rights under UK consumer law`,
  },
  {
    title: "Health & Safety",
    content: `• Clients should inform staff of any health conditions, allergies, injuries, or medications when booking
• The studio may refuse treatment if a condition might compromise client safety
• By attending, clients confirm they are medically fit for the service provided`,
  },
  {
    title: "Client Conduct",
    content: `• All clients are expected to behave respectfully toward staff and other clients
• The studio operates a zero-tolerance policy for abusive or threatening behaviour`,
  },
  {
    title: "Personal Belongings",
    content: `• Clients are responsible for their personal items brought into the studio
• The studio is not liable for loss or damage to belongings`,
  },
  {
    title: "Privacy & Data Protection",
    content: `• Personal data collected for bookings is stored and used in accordance with data protection laws
• Clients may opt out of marketing communications at any time`,
  },
  {
    title: "Changes to Terms",
    content: `• The studio reserves the right to modify policies, prices, or service terms at any time
• Updated policies will be made available on the website and communicated where appropriate`,
  },
];
...
• Legitimate Interests: To provide safe, effective treatments and manage our business`,
  },
  {
    ...
    content: `Your information is stored:
...
To exercise any of these rights, please contact hello@thesolestudionorwich.co.uk`,
  },
  {
    ...
    content: `We may send you information about:

• New treatments and services
• Special offers and promotions
• Appointment reminders and aftercare advice

You can opt out of marketing communications at any time by:
• Clicking 'unsubscribe' in any email
• Contacting us at hello@thesolestudionorwich.co.uk
• Updating your preferences in your booking account

You will continue to receive essential appointment-related communications.`,
  },
];
...
const cookiePolicy = [
  {
    ...
    content: `Cookies are small text files stored on your device when you visit our website. They help us provide you with a better browsing experience and allow certain features to function properly.`,
  },
  {
...
• These are necessary for the booking functionality to work`,
  },
  {
    ...
    content: `Our website may use third-party services that set their own cookies:
...
const termsOfService = [
  {
    ...
    content: `By using this website and booking services, you agree to comply with and be bound by these Terms of Service. If you do not agree with these terms, please do not use our website or services.`,
  },
  {
    title: "Use of Website",
    content: `This website is provided for:

• Information about our services
• Booking appointments
• Accessing health and foot care advice
...
• Text, images, logos, and graphics
• Website design and layout
• Treatment descriptions and advice

is the property of The Sole Studio Norwich or licensed for use. You may not copy, reproduce, or distribute any content without written permission.`,
  },
  {
    title: "Service Limitations",
    content: `The Sole Studio Norwich provides professional foot care treatments but:
...
Always consult your GP for medical concerns.`,
  },
  {
    ...
    content: `By making a booking, you agree to:
...
We reserve the right to refuse or stop treatment if we believe it may compromise your safety.`,
  },
  {
    ...
    content: `Our website may contain links to third-party websites (e.g., booking system, social media). We are not responsible for the content or privacy practices of these sites. Please review their terms and policies separately.`,
  },
  {
    title: "Changes to Terms",
  ...
  {
    title: "Governing Law",
    content: `These Terms of Service are governed by the laws of England and Wales. Any disputes will be subject to the exclusive jurisdiction of the courts of England and Wales.`,
  },
  {
